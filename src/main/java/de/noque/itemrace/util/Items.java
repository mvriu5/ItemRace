package de.noque.itemrace.util;
...
public class Items {
    ...
    public static List<Material> getEasyItems() {
    ...
    public static List<Material> getMediumItems() {
        return Arrays.asList(
    ...
    public static List<Material> getHardItems() {
        return Arrays.asList(
                Material.BEACON,
                Material.BEE_NEST,
                Material.BEEHIVE,
